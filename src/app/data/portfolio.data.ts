...
export const PROFILE: Profile = {
  ...
  summary:
    'Desarrollador Full Stack especializado en Angular, NestJS y React Native, con más de 8 años construyendo aplicaciones web y móviles escalables mediante arquitecturas modulares y eficientes. Mi enfoque se basa en Clean Code, buenas prácticas y optimización del rendimiento. He trabajado en proyectos enterprise y plataformas de micro frontends, integrando autenticación segura (JWT, OAuth), REST APIs y WebSockets, microservicios, bases de datos (MongoDB, PostgreSQL) y despliegues en producción con CI/CD en AWS, Google Cloud y DigitalOcean.',
...
export const SKILL_GROUPS: readonly SkillGroup[] = [
  ...
  },
  {
    title: 'Móvil',
    icon: 'smartphone',
    skills: ['React Native', 'Ionic', 'Flutter', 'Android'],
  },
  {
  ...
  {
    title: 'IA & Arquitectura',
    icon: 'sparkles',
    skills: ['LangChain', 'n8n', 'MCP', 'Agentes IA', 'Design Patterns', 'Clean Architecture', 'Micro Frontends'],
  },
];

/**
 * Curated, live projects — every URL returned HTTP 200 on verification.
 * Featured ones are highlighted first in the grid.
 */
...
/** Highlighted certifications from a total of 40 (⭐ = key ones). */
